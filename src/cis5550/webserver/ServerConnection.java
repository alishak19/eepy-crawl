    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                if (!HTTPRequestResponder.generateResponse(myRequest, theRoutesContainer, theStaticFiles, theSocket)) {
                    LOGGER.info("Used write(): closing connection " + theSocket.getInetAddress());
                    break;
                }
            } catch (IOException e) {
